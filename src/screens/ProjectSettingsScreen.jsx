...
class ProjectSettingsScreen extends React.Component {
  ...
  render() {
    return (
      <div style={{ marginTop: 74, padding: 40 }}>
        {/* <Sidebar items={[{ title: 'display list of apis' }, { title: 'Keys' }]} location={this.props.location} onClick={() => {}} /> */}
        <div className="">
          <p>screen shot from AWS</p><br />
          <img style={{ width: window.innerWidth }} alt="amazon_lex_intent" src={require('img_aws_console_settings.png')} />
        </div>
      </div>
    );
  }
...
ProjectSettingsScreen = connect(state => ({
