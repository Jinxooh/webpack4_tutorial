...
class ProjectBusinessScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      newTrigger: '',
  ...
  render() {
    ...
    return (
      <div className="intent">
        <Sidebar items={[{ title: 'Company Info' }, { title: 'Business Hours' }, { title: 'Staff' }]} location={this.props.location} onClick={() => {}} />
        <div className="">
...
ProjectBusinessScreen = connect(state => ({
...
}), actions)(ProjectBusinessScreen);

export default ProjectBusinessScreen;
