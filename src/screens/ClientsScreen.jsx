      ...
      <table>
        ...
        <tbody>
          {new Array(3).fill(undefined).map((item, index) => {
            return (
              <tr key={index}>
                <td><button className="automate-intent-name" onClick={() => this.props.pushRoute(`${defaultRoute}/client/${type}/111}`)}>{`${type} ${index}`}</button>
                </td>
      ...
      <div className="automate" style={{ marginLeft: 230 }}>
        <div className="top-container">
          <div className="buttons-container">
            <button className="new">New Client</button>
